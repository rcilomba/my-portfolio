        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <div className='pt-8 text-center'>
                <a
                  href='https://inspiring-monstera-a935e6.netlify.app/'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                ...
                <a
                  href='https://github.com/rcilomba/game-board'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-400' aria-label='Open Game Board code in new tab'>
          ...
          >
            ...
            <div className='opacity-0 group-hover:opacity-100 flex justify-center items-center flex-col'>
              ...
              <div className='pt-8 text-center'>
                <a
                  href='https://cute-meringue-180ad7.netlify.app/'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                ...
                <a
                  href='https://github.com/rcilomba/js-photo-gallery'
                  target='_blank'
                  rel='noopener noreferrer'
                >
